...
##  Feature 1: **Auto-discovery / Listing of Events in a Subsystem**

### 🔧 What it does:

Adds a `--list <subsystem>` flag to list all available trace events under a given subsystem and exit without monitoring.
...
```
Available events in subsystem 'sched':
  sched_kthread_stop
...
* It lists the directories under:
  `/sys/kernel/debug/tracing/events/<subsystem>/`
* Each directory represents a valid trace event.

---

### Code Changes

Below is the **modified** `main.rs` that includes this feature:
